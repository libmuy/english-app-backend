...
$query = "
    SELECT cm.id, cm.name, description, NULL AS audio_length_sec, NULL AS sub_count
    ...
    SELECT cr.id, cr.name, description, NULL AS audio_length_sec, cr.episode_count AS sub_count
    FROM favorite_resource fr
    ...
    SELECT em.id, em.name, NULL AS description, em.audio_length_sec, em.sentence_count AS sub_count
    FROM favorite_resource fr
